...
public class SlidingDistanceTester
{
    ...
    public static void main(String[] args) throws IOException
    {
	  ...
	  System.out.println("*     (Uses the Distance Heuristic)     *");
      System.out.println("*****************************************");
        ...
        if (userIn.equalsIgnoreCase("quit")) //if user typed quit, stops program
          break;
              ...
              try
              {
                ...
                System.out.println("Sliding Distance Output for " + userIn);
                System.out.println("(" + size + " x " + size + " Board)");
				System.out.println(" ");

                PWOut.println("Sliding Distance Output for " + userIn);
                PWOut.println("(" + size + " x " + size + " Board)");
				PWOut.println(" ");

                //Creating new SlidingDistance object of SlidingDistance class with parameters
                //read in from files
                SlidingDistance sD = new SlidingDistance(initialBoard, finalBoard, size, PWOut);
                sD.timedSolve(); //starting solve method
